...
export const en = {
  ...
  loadout: {
    title: 'LOADOUT',
    hint: '[C] character · [X] clear · [F] forge · [Enter] start',
    backButton: '← MENU',
    charStats: '{hp} HP / {sh} SHIELD',
    ownedChars: 'characters owned: {count}',
    materialsLine: 'Materials   {bank}',
    slotsLine: 'Weapons taken in   {count}/{max}',
    craftedTag: 'forged',
    starterTag: 'default kit',
    forgeCardName: 'FORGE',
    forgeCardHint: 'craft weapons ▸',
    clearLoadout: 'CLEAR LOADOUT',
    startRun: 'START RUN ▸',
    continueRun: 'CONTINUE RUN ▸',
    savedRunLine: 'Saved run: floor {floor}, {m}:{ss} played — CONTINUE to resume it, START RUN to discard it',
  },
  ...
  results: {
    ...
    guestNotRanked: 'Not ranked as a guest. Sign in to rank.',
  ...
  toast: {
    ...
    characterFound: 'New character: {character}',
    buffNamed: 'Buff: {id}',
    buffGeneric: 'Buff',
    ...
    runSaved: 'Run saved — continue it from the forge',
    runSaveFailed: 'Could not save this run',
    runSaveOldVersion: 'That saved run is from an older version of the game',
    runSaveStale: 'That saved run no longer matches this dungeon',
  },
  compareCard: {
    damage: 'Damage',
    type: 'Type',
