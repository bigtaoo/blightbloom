...
export const es: Translations<typeof en> = {
  ...
  forge: {
    ...
    craftableSchematic: 'fabricable (esquema ×{count})',
  ...
  party: {
    ...
    headerSquad: 'ESCUADRA PVP · {count}/{capacity}',
  },
  pvpPreview: {
    title: 'PARTIDA PVP',
  ...
  matchmaking: {
    ...
    botSoon: 'Jugadores IA ocuparán los huecos en {seconds}s',
    botNow: 'Ocupando los huecos con jugadores IA…',
  ...
  toast: {
    ...
    characterFound: 'Nuevo personaje: {character}',
    buffNamed: 'Mejora: {id}',
    buffGeneric: 'Mejora',
  ...
  card: {
    ...
    surge: { name: 'Sobrecarga', desc: 'La energía vale {factor}x' },
    aegis: { name: 'Égida', desc: 'Los escudos valen {factor}x' },
    stockpile: { name: 'Acopio', desc: 'Los materiales valen {factor}x' },
    bounty: { name: 'Botín', desc: '+{count} arma por cofre' },
  },
  buff: {
